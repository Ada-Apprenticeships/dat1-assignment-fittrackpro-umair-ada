...
-- ATTENDANCE Table Insertions
INSERT INTO attendance (attendance_id, member_id, location_id, check_in_time, check_out_time) VALUES (1, 5, 1, '2025-01-10 08:00:00', '2025-01-10 09:30:00');
INSERT INTO attendance (attendance_id, member_id, location_id, check_in_time, check_out_time) VALUES (2, 5, 1, '2025-01-12 18:00:00', '2025-01-12 19:15:00');
...
INSERT INTO class_attendance (class_attendance_id, schedule_id, member_id, attendance_status) VALUES (2, 1, 3, 'Attended');
INSERT INTO class_attendance (class_attendance_id, schedule_id, member_id, attendance_status) VALUES (3, 7, 3, 'Registered');
INSERT INTO class_attendance (class_attendance_id, schedule_id, member_id, attendance_status) VALUES (4, 3, 5, 'Registered');
INSERT INTO class_attendance (class_attendance_id, schedule_id, member_id, attendance_status) VALUES (5, 2, 1, 'Attended');
INSERT INTO class_attendance (class_attendance_id, schedule_id, member_id, attendance_status) VALUES (6, 2, 2, 'Registered');
INSERT INTO class_attendance (class_attendance_id, schedule_id, member_id, attendance_status) VALUES (7, 3, 4, 'Attended');
INSERT INTO class_attendance (class_attendance_id, schedule_id, member_id, attendance_status) VALUES (13, 7, 1, 'Attended');
INSERT INTO class_attendance (class_attendance_id, schedule_id, member_id, attendance_status) VALUES (14, 8, 2, 'Attended');
INSERT INTO class_attendance (class_attendance_id, schedule_id, member_id, attendance_status) VALUES (15, 9, 5, 'Attended');

-- PAYMENTS Table Insertions
INSERT INTO payments (payment_id, member_id, amount, payment_date, payment_method, payment_type) VALUES (1, 1, 40.00, '2024-11-01 10:00:00', 'Credit Card', 'Monthly membership fee');
INSERT INTO payments (payment_id, member_id, amount, payment_date, payment_method, payment_type) VALUES (2, 2, 60.00, '2024-11-15 12:00:00', 'Bank Transfer', 'Monthly membership fee');
INSERT INTO payments (payment_id, member_id, amount, payment_date, payment_method, payment_type) VALUES (3, 3, 40.00, '2024-12-20 09:00:00', 'Credit Card', 'Monthly membership fee');
INSERT INTO payments (payment_id, member_id, amount, payment_date, payment_method, payment_type) VALUES (4, 5, 60.00, '2024-12-10 14:00:00', 'PayPal', 'Monthly membership fee');
INSERT INTO payments (payment_id, member_id, amount, payment_date, payment_method, payment_type) VALUES (5, 1, 40.00, '2025-01-01 10:00:00', 'Credit Card', 'Monthly membership fee');
INSERT INTO payments (payment_id, member_id, amount, payment_date, payment_method, payment_type) VALUES (6, 2, 60.00, '2025-01-15 12:00:00', 'Bank Transfer', 'Monthly membership fee');
INSERT INTO payments (payment_id, member_id, amount, payment_date, payment_method, payment_type) VALUES (7, 11, 20.00, '2025-01-20 15:30:00', 'Cash', 'Day pass');

-- CLASS_SCHEDULE Table Insertions
INSERT INTO class_schedule (schedule_id, class_id, staff_id, start_time, end_time) VALUES (1, 1, 2, '2025-02-01 09:00:00', '2025-02-01 09:45:00');
INSERT INTO class_schedule (schedule_id, class_id, staff_id, start_time, end_time) VALUES (2, 2, 4, '2025-02-01 10:00:00', '2025-02-01 11:00:00');
INSERT INTO class_schedule (schedule_id, class_id, staff_id, start_time, end_time) VALUES (3, 3, 2, '2025-02-02 18:00:00', '2025-02-02 18:30:00');
INSERT INTO class_schedule (schedule_id, class_id, staff_id, start_time, end_time) VALUES (7, 2, 4, '2025-02-05 12:00:00', '2025-02-05 13:00:00');

-- CLASSES Table Insertions
INSERT INTO classes (class_id, name, description, capacity, duration, location_id) VALUES (1, 'Spin Class', 'High intensity indoor cycling', 20, 45, 1);
INSERT INTO classes (class_id, name, description, capacity, duration, location_id) VALUES (2, 'Yoga Basics', 'Beginner level yoga', 15, 60, 1);
